...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
        		...
        		.mvcMatchers(HttpMethod.POST, "/prod/sgc/token/**").permitAll()
        		.mvcMatchers(HttpMethod.GET, "/prod/sgc/access/**").permitAll()
        		.mvcMatchers(HttpMethod.PUT, "/prod/sgc/access/**").permitAll()
        		.mvcMatchers(HttpMethod.POST, "/prod/sgc/access/**").permitAll()
        		.mvcMatchers(HttpMethod.POST, "/prod/sgc/contribuicao/**").permitAll()
        		.mvcMatchers(HttpMethod.GET, "/prod/sgc/contribuicao/**").permitAll()
